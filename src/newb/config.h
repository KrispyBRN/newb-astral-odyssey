...
#define NL_CLOUD2_STEPS 15                 // 3 low quality ~ 16 high quality
#define NL_CLOUD2_SCALE vec2(0.012, 0.012) // 0.003 large ~ 0.3 tiny
...
#define NL_END_STREAKS_DENSITY 40.0  // 10.0 few, thick ~ 100.0 many, thin
#define NL_END_STREAKS_SPEED 0.08    // 0.0 static ~ 0.5 very fast
#define NL_END_STREAKS_INTENSITY 1.0 // 0.0 off ~ 3.0 very bright
