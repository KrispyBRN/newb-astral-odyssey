...
#define NL_DAWN_SUNLIGHT_COL   vec3(1.0,0.48,0.1)
...
#define NL_DAWN_ZENITH_COL   vec3(0.55,0.22,0.12)
#define NL_DAWN_HORIZON_COL  vec3(3.0,1.3,0.2)
#define NL_DAWN_EDGE_COL     vec3(2.6,1.5,0.5)
...
#define NL_NIGHT_ZENITH_COL  vec3(0.045,0.05,0.06)
#define NL_NIGHT_HORIZON_COL vec3(0.065,0.07,0.08)
#define NL_NIGHT_EDGE_COL    vec3(0.085,0.09,0.1)
...
#define NL_CLOUD2_LAYER2_THICKNESS 3.5          // 0.7 slim ~ 5.0 fat
...
#define NL_AURORA_CURTAIN_COL1 vec3(0.1, 1.4, 0.4)  // colour low on the curtain (near horizon)
#define NL_AURORA_CURTAIN_COL2 vec3(0.9, 0.2, 1.1)  // colour higher up the curtain (near zenith)
...
#define NL_GODRAY_FULLMOON_COL vec3(0.75, 0.82, 0.9) // colour of the full-moon rays (pale cool moonlight)
