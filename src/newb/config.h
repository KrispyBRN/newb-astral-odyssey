...
#define NL_DAWN_SUNLIGHT_COL   vec3(1.0,0.55,0.15)
...
#define NL_DAWN_ZENITH_COL   vec3(0.5,0.25,0.15)
#define NL_DAWN_HORIZON_COL  vec3(3.0,1.6,0.3)
#define NL_DAWN_EDGE_COL     vec3(2.5,2.0,1.0)
